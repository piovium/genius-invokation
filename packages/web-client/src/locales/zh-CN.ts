...
export default {
  ...
  createDeckFirst: "请先创建一个牌组",
  profile: "个人信息",
  nickname: "昵称",
  chessboardColor: "牌桌颜色",
  gameRecords: "对局记录",
  guestNoGameRecords:
    "游客模式不会保留对局记录，如需保留，请使用 GitHub 登录。",
  ...
  guestModeHint:
    "在游客模式下：\n- 您的牌组将保存在本地，不会在云端同步；\n- 您的对局记录不会保存到任何地方。\n\n如果您希望将对局中的 bug 反馈给开发者，强烈建议您使用 GitHub 登录，以便我们从数据库中查询对局记录。",
  roomConfig: "房间配置",
  thinkingTime: "思考时间",
  ...
  backHome: "回到首页",
  roomLoading: "房间加载中……",
  roomReconnecting: "正在重新连接并同步对局……",
  roomActionUnknown:
    "尚无法确认上一次操作的结果，请刷新房间以同步对局后再操作。",
  roomCommandPending: "请等待上一次操作得到确认后再操作。",
  roomInvalidLink: "房间链接不完整或无效。",
