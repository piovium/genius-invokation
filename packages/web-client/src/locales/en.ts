...
export default {
  ...
  guestNoGameRecords:
    "Guest mode does not keep match records. Sign in with GitHub to keep them.",
  ...
  guestModeHint:
    "In guest mode:\n- Your decks are stored locally and never sync to the cloud.\n- Your match history will not be saved anywhere.\n\nIf you want to report bugs in a match, we strongly recommend signing in with GitHub so we can inspect the stored match record.",
  ...
  youAreSecond: "Your opponent goes first",
