              ...
              <div class="flex flex-grow flex-col-reverse md:flex-row gap-8 md:gap-0 min-h-0">
                <div class="h-full w-full md:w-128 flex flex-col items-start md:bottom-opacity-gradient">
                  ...
                  <Switch>
                    ...
                    <Match when={true}>
                      <div class="deck-grid scrollbar-thin-hover grid w-full grid-cols-[repeat(auto-fill,minmax(150px,1fr))] gap-2 md:grid-cols-[repeat(auto-fill,minmax(200px,1fr))] md:gap-3 md:pr-6 md:overflow-y-auto">
                        <For
                          each={decks().data}
                          fallback={
                            <div class="text-gray-500">
