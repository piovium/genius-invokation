...
import { CardHandle, CharacterHandle, DamageType, DiceType, Pair, SkillHandle, SupportHandle, card, extension, flip, pair, status, summon, type } from "@gi-tcg/core/builder";
