...
export const GITCG_ATTR_STATE_PLAYER_DEFEATED_SWITCHING_0 = 5070;
export const GITCG_ATTR_STATE_PLAYER_DEFEATED_SWITCHING_1 = 5071;
...
export const GITCG_ENTITY_TYPE_EVENT_CARD = 7;
export const GITCG_ENTITY_TYPE_ATTACHMENT = 8;
